  ...
  return (
    <div ref={containerRef} className="absolute top-6 right-8 z-50">
      ...
      <div
        ...
        className="flex items-center gap-3 bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800 rounded-full px-4 py-2 shadow-lg shadow-black/5 cursor-pointer select-none"
      >
        {/* Initials avatar */}
