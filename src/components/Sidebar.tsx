            ...
            <div className="mt-3">
              ...
              <div className="relative mb-2">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-1.5 text-sm rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-400/40 border-0"
                />
              </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0 pr-8">
                        ...
                        <div className="text-xs text-gray-400 dark:text-gray-500 truncate leading-tight">{client.domain}</div>
                      </div>
                    </button>
